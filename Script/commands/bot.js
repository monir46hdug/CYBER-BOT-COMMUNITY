...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "মনির") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "তোর বস কে ")) {
     return api.sendMessage("My Creator:ULLASH ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস মনির আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ullash ッ❤️ তাকে সবাই মনিট নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "শুমু") || (event.body.toLowerCase() == "শুমু ")) {
     return api.sendMessage("ওন্ন কন বেডার বউ", threadID);
   };

  if ((event.body.toLowerCase() == "মিম") || (event.body.toLowerCase() == "mim")) {
     return api.sendMessage("মনিরের sixe বান্দবি..!😠😁🖕🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "মুন্নি") || (event.body.toLowerCase() == "Munni ")) {
     return api.sendMessage(" মিষ্টির সতিন..!🙄🙃☠️😹", threadID);
   };
